...
CHOICES = {'n_time': range(21, 100), # Timesteps in one datapoint.
           ...
           'cost_type': ['sharpe', 'min_return', 'mean_return'],
...
if __name__ == '__main__':
    ...
    if os.path.isfile('saved_data/hyper_new_results.pkl'):
        HYPER_RESULTS = joblib.load('saved_data/hyper_new_results.pkl')
    else:
        HYPER_RESULTS = []
...
#for run in range(N_RUNS):
    ...
    # Save the results
    joblib.dump(HYPER_RESULTS, 'saved_data/hyper_new_results.pkl')
